...
<head>
    ...
    <style>
        label.imgUp{
            display: block;
            background-color: rgb(9, 163, 143);
            color: white;
            padding: 0.5rem;
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse {{ (request()->is('admin/organization/request/list') || request()->is('admin/organization/list')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ (request()->is('admin/organization/request/list') ? 'active': '') }}" href="{{ route('organization.request.list') }}">Organization Requests List</a>
                        <a class="collapse-item {{ (request()->is('admin/organization/list') ? 'active': '') }}" href="{{ route('organization.list') }}">Organizations List</a>
